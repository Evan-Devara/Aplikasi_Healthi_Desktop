...
class bayarObat(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(828, 688)
        ...
        self.label_4.setGeometry(QtCore.QRect(60, 220, 95, 41))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.toolButton_3.setText(_translate("Dialog", "Bayar"))
        self.label_4.setText(_translate("Dialog", "Total Harga"))
        self.label_2.setText(_translate("Dialog", "Nama Pasien"))
        self.label_3.setText(_translate("Dialog", "Nama Obat"))
        self.label_14.setText(_translate("Dialog", "Pilih nama anda dengan benar"))
        self.label_15.setText(_translate("Dialog", "dan benar"))
        self.pushButton_3.setText(_translate("Dialog", "Bayar"))

    def simpanData(self):
        nama = self.comboBox.currentText()
        nama_obat = self.lineEdit_11.text()
        total_harga = self.lineEdit_2.text()
        try:
            mydb = mc.connect(
                host="localhost",
                user="root",
            ...
            query = "INSERT INTO pembayaran(id_pasien, nama_obat, harga_total, keterangan) VALUES (%s,%s,%s,%s)"
            value = (id_pasiennya, nama_obat, total_harga, 'Sudah Dibayar')
            mycursor.execute(query, value)
            mydb.commit()
            print(nama, nama_obat, total_harga)
